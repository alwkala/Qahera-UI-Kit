...
const COMPONENT_METADATA = {
  ...
  cartouche:       { category: 'containers', interactive: false, usesIcon: false },
  ...
  frieze:          { category: 'data-display', interactive: false, usesIcon: false },
  ...
  seal:            { category: 'feedback',   interactive: false, usesIcon: true  },
...
const PATTERN_COMPONENTS = {
  ...
  'chat-stream':            ['card', 'input', 'button', 'avatar'],
  'date-paginator':         ['button', 'badge'],
  'file-manager-grid':      ['card', 'badge', 'button', 'dropdown'],
  'hero-skyline-panorama':  ['card', 'badge', 'button'],
  'kanban-board':           ['card', 'badge', 'button'],
  'metric-comparison-grid': ['card', 'badge', 'progress'],
  'questionnaire':          ['card', 'button', 'radio', 'progress'],
  'sortable-list':          ['card', 'button', 'badge'],
  'user-card':              ['card', 'avatar', 'badge', 'button'],
};
...
const PATTERN_REACT_NAMES = {
  ...
  'chat-stream':            'ChatStream.tsx',
  'date-paginator':         'DatePaginator.tsx',
  'file-manager-grid':      'FileManagerGrid.tsx',
  'hero-skyline-panorama':  'HeroSkylinePanorama.tsx',
  'kanban-board':           'KanbanBoard.tsx',
  'metric-comparison-grid': 'MetricComparisonGrid.tsx',
  'questionnaire':          'Questionnaire.tsx',
  'sortable-list':          'SortableList.tsx',
  'user-card':              'UserCard.tsx',
};
...
const TEMPLATE_COMPONENTS = {
  'academic-executive': ['card', 'badge', 'button', 'frieze', 'seal', 'cartouche'],
  ...
  'box-cards':          ['card', 'badge', 'button', 'ribbon'],
  charts:               ['card', 'badge', 'button'],
  ...
  emails:               ['card', 'button'],
  errors:               ['card', 'button'],
  'file-manager':       ['card', 'button', 'badge', 'dropdown'],
  'fintech-wealth':     ['card', 'badge', 'table', 'button'],
  'flagship-portal':    ['navbar', 'card', 'button', 'badge', 'dock', 'cartouche', 'frieze'],
  'helpdesk-kanban':    ['card', 'badge', 'button', 'input'],
  landing:              ['preloader', 'canvas-sparks', 'back-to-top', 'navbar', 'button', 'card', 'badge', 'accordion'],
  layouts:              ['card', 'navbar', 'dock'],
  shop:                 ['card', 'badge', 'button', 'select', 'input'],
  tables:               ['table', 'badge', 'button', 'pagination', 'input'],
  widgets:              ['card', 'badge', 'button', 'progress'],
};

const TEMPLATE_PATTERNS = {
  'academic-executive': ['editorial-story'],
  admin:                ['data-table-toolbar', 'filter-bar', 'pagination', 'confirmation'],
  dashboard:            ['dashboard-stat', 'metric-comparison-grid'],
  auth:                 ['form-actions'],
  'box-cards':          ['luxury-product-card', 'user-card'],
  charts:               ['dashboard-stat'],
  ...
  education:            ['search-toolbar', 'pagination', 'questionnaire'],
  emails:               ['form-actions'],
  errors:               ['empty-state'],
  'file-manager':       ['file-manager-grid', 'search-toolbar'],
  'fintech-wealth':     ['dashboard-stat', 'metric-comparison-grid'],
  'flagship-portal':    ['hero-skyline-panorama', 'editorial-story'],
  'helpdesk-kanban':    ['kanban-board', 'chat-stream'],
  landing:              ['hero-skyline-panorama', 'editorial-story', 'vip-membership', 'form-actions'],
  layouts:              ['search-toolbar'],
  shop:                 ['luxury-product-card', 'search-toolbar', 'filter-bar', 'pagination'],
  tables:               ['data-table-toolbar', 'pagination', 'filter-bar'],
  widgets:              ['dashboard-stat', 'date-paginator'],
};

const TEMPLATE_REACT_NAMES = {
  'academic-executive': 'AcademicExecutivePage.tsx',
  admin:                'AdminPage.tsx',
  auth:                 'AuthPage.tsx',
  'box-cards':          'BoxCardsPage.tsx',
  charts:               'ChartsPage.tsx',
  dashboard:            'DashboardPage.tsx',
  documentation:        'DocumentationPage.tsx',
  ecommerce:            'EcommercePage.tsx',
  education:            'EducationPage.tsx',
  emails:               'EmailsPage.tsx',
  errors:               'ErrorPage.tsx',
  'flagship-portal':    'FlagshipPortalPage.tsx',
  landing:              'LandingPage.tsx',
  layouts:              'LayoutsPage.tsx',
  shop:                 'ShopPage.tsx',
  tables:               'TablesPage.tsx',
  widgets:              'WidgetsPage.tsx',
};
...
function listComponents() {
  ...
  console.log('='.repeat(70));
  console.log(`\nTotal: ${CANONICAL_COMPONENTS.length} components · ${CANONICAL_PATTERNS.length} patterns · ${CANONICAL_TEMPLATES.length} templates · 46 canonical icons.`);
