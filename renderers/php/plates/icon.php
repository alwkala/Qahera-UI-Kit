 ...
 * 
 * Renders an authoritative semantic SVG icon from icons/registry.yaml (41 icons).
...
// Authoritative SVG paths from icons/registry.yaml
$iconPaths = [
    // Navigation
...
$path = $iconPaths[$name] ?? $iconPaths['info'];
...
<svg 
  ...
  class="qhr-icon qhr-icon--<?= $this->e($name) ?><?= $isSpinner ? ' qhr-icon--spin' : '' ?> <?= $this->e($extraClass) ?>" 
  aria-hidden="true"
>
  <path d="<?= $path ?>" />
</svg>
